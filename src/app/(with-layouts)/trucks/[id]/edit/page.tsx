import { getTruck, updateTruck } from "@/app/actions/masters";
import {
  FormActions,
  FormField,
  FormGrid,
...
export default async function EditTruckPage({
  ...
  return (
    <div className="mt-6 space-y-6">
      <PageToolbar title="تعديل شاحنة" backHref="/trucks" />
      <div className="px-2 lg:px-5">
        <Card className="max-w-2xl bg-transparent p-5">
          <FormTitle>{truck.plate}</FormTitle>
            ...
            <FormGrid>
              ...
              <FormField>
                ...
                <Input
                  ...
                  type="number"
                  step="0.01"
                  defaultValue={truck.payloadM3 != null ? String(truck.payloadM3) : ""}
                  className="w-full"
                />
              </FormField>
              <FormField>
