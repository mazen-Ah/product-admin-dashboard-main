    ...
    <div className="flex h-full">
      ...
      <SheetOverlay isOpen={isMobileSheetOpen} onOpenChange={setIsMobileSheetOpen}>
        <SheetContent
          ...
          className="w-67.5! max-w-67.5! border-s border-card-border bg-card-surface-area p-0"
        >
      ...
      <div className={cn("min-w-0 flex-1", isSidebarOpen ? "lg:p-4 xl:pe-4" : "lg:py-4 xl:px-4")}>
